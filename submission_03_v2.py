...
reg.fit(np.array(x_train_headline), y_train_headline)

y_train_headline_pred = reg.predict(np.array(x_train_headline))
mae_headline_train = mean_absolute_error(y_train_headline, y_train_headline_pred)
print("mae_headline_train: ", mae_headline_train)

y_valid_headline_pred = reg.predict(np.array(x_valid_headline))
...
reg.fit(np.array(x_headline_train), y_headline_train)

x_headline_test = test['Headline']
#x_headline_test_transformed = text_transformation(x_headline_test)
x_headline_test = reg.predict(np.array(x_headline_test))
